...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-surface">
      <AppHeader />
      <main className="flex-grow flex flex-col justify-between items-center px-6 pt-20 pb-8 w-full max-w-md mx-auto">
        <div className="flex flex-col items-center mt-4 w-full">
          {/* Logo animation */}
          <div className="relative flex items-center justify-center w-32 h-32 mb-5">
          ...
          <div className="text-center max-w-xs space-y-2">
            <h1 className="text-5xl font-black tracking-tighter text-on-surface">SkinX</h1>
            <p className="text-[17px] text-on-surface-variant font-medium leading-snug">
              {t.welcome.headline}
            </p>
          </div>
        </div>
